...
class Surveys:
    ...
    def age_distribution(self):
        age_distribution_data = {"0-4": 0, "5-9": 0, "10-14": 0, "15-19": 0, "20-24": 0, "25-29": 0, "30-34": 0, "35-39": 0, "40-44": 0, "45-49": 0, 
        ...
        for _, age in self.data:
            ...
            age_distribution_data[age_labels[index]] += 1
    ...
    def wealth_distribution(self):
        ...
        age_distribution_data = {f"{i*spacing}-{(i + 1) * spacing}" : 0 for i in range(20)}
        ...
        for wealth in wealth_mains:
            ...
            age_distribution_data[f"{wealth_maxs[index-1]}-{wealth}"] += 1
        age_distribution_data[f"{wealth_maxs[0]}+"] = len(wealth_maxs)
